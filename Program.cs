...
SearchIndex GetSampleIndex(string name)
{
...
async Task SingleVectorSearch(SearchClient searchClient, OpenAIClient openAIClient, string query, int k = 3)
{
...
async Task SingleVectorSearchWithFilter(SearchClient searchClient, OpenAIClient openAIClient, string query, string filter)
{
    // Generate the embedding for the query
    var queryEmbeddings = await GenerateEmbeddings(query, openAIClient);
...
async Task SimpleHybridSearch(SearchClient searchClient, OpenAIClient openAIClient, string query)
{
    // Generate the embedding for the query
    var queryEmbeddings = await GenerateEmbeddings(query, openAIClient);
...
async Task SemanticHybridSearch(SearchClient searchClient, OpenAIClient openAIClient, string query)
{
    try
    {
        // Generate the embedding for the query
